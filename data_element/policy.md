...
- 全流程密态保障：基于硬件隔离环境或密码协议，构建机密虚拟机、TEE OS、机密容器、密态胶囊等，结合密态互联实现全链路密态。
  ...
  - 密态胶囊：数据与使用策略（数字合约）绑定胶囊；用户通过加密确保只有指定可信应用能接收到；用户通过检查代码，确认可信应用会严格检查策略。
    ...
    <img width="450" height="236" alt="image" src="https://github.com/user-attachments/assets/b560c521-d577-4d31-9d87-5e9d1f48eb29" />
 
    <img width="524" height="200" alt="image" src="https://github.com/user-attachments/assets/b27af432-f12f-4b56-85d3-f3705346efab" />
