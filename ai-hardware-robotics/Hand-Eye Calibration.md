...
$(T^b_{e2})^{-1}T^b_{e1}T^{e1}{c1}T^{c1}{t} =T^{e2}{c2}T^{c2}{t} \ (T^b_{e2})^{-1}T^b_{e1}T^{e1}{c1} =T^{e2}{c2}T^{c2}{t}(T^{c1}{t})^{-1} \ T^{e2}{e1}T^{e1}{c1} =T^{e2}{c2}T^{c2}{c1} \ T^{e2}{e1}T^{e}{c} =T^{e}{c}T^{c2}{c1} \ AH = HB$
...
$T^{e1}bT^{b}{c}T^{c}{t1} = T^{e2}bT^{b}{c}T^{c}{t2} \ (T^{e2}b)^{-1}T^{e1}bT^{b}{c}T^{c}{t1} = T^{b}{c}T^{c}{t2} \ (T^{e2}b)^{-1}T^{e1}bT^{b}{c} = T^{b}{c}T^{c}{t2}(T^{c}{t1})^{-1} \ (T^b_{e2}T^{e1}b)T^{b}{c} = T^{b}{c}(T^{c}{t2}T^{t1}_c) \ AH = HB$
