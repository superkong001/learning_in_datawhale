...
$$
\text{perplexity} \left( p \left( x_{1:L} \right) \right) = \exp \left( \frac{1}{L} \sum_{i = 1}^{L} \log \frac{1}{p \left( x_{i} \mid x_{1:i - 1} \right)} \right)
$$

$$
\text{perplexity}_p \left(x_{1: L} \right)= \exp \left( \frac{1}{L} \sum_{i=1}^L \log \frac{1}{p \left( x_i \mid x_{1:i-1} \right)} \right) 
$$
